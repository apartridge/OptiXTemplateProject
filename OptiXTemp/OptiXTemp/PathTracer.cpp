...
void PathTracerScene::initScene( InitialCameraData& camera_data )
{
	...
	// Setup programs
	std::string ptx_path = "PathTracer.cu.obj";
...
void PathTracerScene::createGeometry()
{
	...
	Program diffuse_ch = m_context->createProgramFromPTXFile( "PathTracer.cu.obj", "diffuse" );
	Program diffuse_ah = m_context->createProgramFromPTXFile( "PathTracer.cu.obj", "shadow" );
	diffuse->setClosestHitProgram( 0, diffuse_ch );
	diffuse->setAnyHitProgram( 1, diffuse_ah );

	Material diffuse_light = m_context->createMaterial();
	Program diffuse_em = m_context->createProgramFromPTXFile( "PathTracer.cu.obj" , "diffuseEmitter" );
